...
public class Look {
    ...
    public Double getDiscountdoller() {
        return discountdoller;
    }

    public void setDiscountdoller(Double discountdoller) {
        this.discountdoller = discountdoller;
    }
